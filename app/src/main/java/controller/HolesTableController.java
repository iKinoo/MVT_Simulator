...
public class HolesTableController implements Initializable{
    ...
    @FXML private TableColumn<Hole, Integer> holeNumber;
    @FXML private TableColumn<Hole, Integer> holeLocation;
    @FXML private TableColumn<Hole, Integer> holeSize;
    @FXML private TableColumn<Hole, String> holeStatus;
